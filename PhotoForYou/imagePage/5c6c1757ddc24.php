<?php
							...
							$prix_img = 10;
							$lien_php = "imagePage/5c6c1757ddc24.php";
							...
							<!DOCTYPE html> <html lang="fr"> 
								...
								<body> 
									...
									<div id="body"> 
										<div id="content"></div> 
											<h1 style="text-align: center; text-decoration: underline;">voiture </h1><br/> 
										...
										$select_acheteur_dl = "SELECT nom_img, prix_img, lien_img, lien_php, description_img, actif_img, idAcheteur
												FROM image
									 			WHERE lien_php = '"imagePage/5c6c1757ddc24.php"';";
										...
										else 
										{
												echo('<form name="frm" id="form_doc" method="post" action="../transfert_achat.php">
													<center>
														...
														<input type="hidden" value="imagePage/5c6c1757ddc24.php" name="lien_php"/>
