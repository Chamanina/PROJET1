<?php
							...
							$prix_img = 20;
							$lien_php = "imagePage/5cb891f7a9576.php";
								...
								<body> 
									...
									<div id="body"> 
										...
										$select_acheteur_dl = "SELECT nom_img, prix_img, lien_img, lien_php, description_img, actif_img, idAcheteur, idUser, idAdmin
												FROM image
									 			WHERE lien_php = 'imagePage/5cb891f7a9576.php';";
										...
										{
											echo('<center>
											<a href="../transfert_delete_img.php?file_delete=imagePage/5cb891f7a9576.php&amp;confirmation=false">
										...
										else 
										{
												echo('<form name="frm" id="form_doc" method="post" action="../transfert_achat.php">
													<center>
														...
														<input type="hidden" value="imagePage/5cb891f7a9576.php" name="lien_php"/>
