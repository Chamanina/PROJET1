<?php
							...
							$prix_img = 10;
							$lien_php = "imagePage/5c6c056ab8352.php";
							$lien_img = "image/renard.jpg";
							$idUser = 1;
							$actif_img = 1;
							?> 
							<!DOCTYPE html> <html lang="fr"> 
								...
								<body> 
									...
									<div id="body"> 
										<div id="content"></div> 
											<h1 style="text-align: center; text-decoration: underline;">gfdgdfg </h1><br/> 
											<img src="../image/renard.jpg"style="width:775px ; border-radius: 5px" /><br/><br/>
										...
										elseif(isset($_SESSION['email_user']) && $result)
										{
											echo('<center>
										...
										else 
										{
												echo('<form name="frm" id="form_doc" method="post" action="../transfert_achat.php">
													<center>
														...
														<input type="hidden" value="image/renard.jpg" name="lien_img"/>
														<input type="hidden" value="1" name="actif_img"/>
														<input type="hidden" value="10" name="prix_img"/>
														<input type="hidden" value="imagePage/5c6c056ab8352.php" name="lien_php"/>
