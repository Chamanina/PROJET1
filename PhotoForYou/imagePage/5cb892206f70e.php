<?php
							...
							$prix_img = 10;
							$lien_php = "imagePage/5cb892206f70e.php";
							$lien_img = "image/mer.jpg";
							$idUser = 2;
							$actif_img = 1;
							?> 
							<!DOCTYPE html> <html lang="fr"> 
								...
								<body> 
									...
									<div id="body"> 
										<div id="content"></div> 
										<center>
											<h1 style="text-align: center; text-decoration: underline;">hhhh </h1><br/> 
											<img src="../image/mer.jpg"style="width:775px ; border-radius: 5px" /><br/><br/>
										</center>
										...
										$select_acheteur_dl = "SELECT nom_img, prix_img, lien_img, lien_php, description_img, actif_img, idAcheteur, idUser, idAdmin
												FROM image
									 			WHERE lien_php = 'imagePage/5cb892206f70e.php';";
										...
										elseif($_SESSION['idUser'] == $result['idAcheteur'])
										{
											echo('
												<center>
												<a href="../transfert_dl.php?file=image/mer.jpg">
										...
										{
											echo('<center>
											<a href="../transfert_delete_img.php?file_delete=imagePage/5cb892206f70e.php&amp;confirmation=false">
										...
										else 
										{
												echo('<form name="frm" id="form_doc" method="post" action="../transfert_achat.php">
													<center>
														...
														<input type="hidden" value="image/mer.jpg" name="lien_img"/>
														<input type="hidden" value="1" name="actif_img"/>
														<input type="hidden" value="10" name="prix_img"/>
														<input type="hidden" value="imagePage/5cb892206f70e.php" name="lien_php"/>
