<?php
							...
							$prix_img = 5;
							$lien_php = "imagePage/5c6ad9c0580ed.php";
							$idUser = 10;
							?> 
							<!DOCTYPE html> <html lang="fr"> 
								...
								<body> 
									...
									<div id="body"> 
										<div id="content"></div> 
											<h1 style="text-align: center; text-decoration: underline;">fefsqdf </h1><br/> 
										...
										else 
										{
												echo('<form name="frm" id="form_doc" method="post" action="../transfert_achat.php">
													<center>
														...
														<input type="hidden" value="imagePage/5c6ad9c0580ed.php" name="lien_php"/>
