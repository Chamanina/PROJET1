<?php
							...
							$prix_img = 10;
							$lien_php = "imagePage/5c6c03d90f6b3.php";
							...
							<!DOCTYPE html> <html lang="fr"> 
								...
								<body> 
									...
									<div id="body"> 
										<div id="content"></div> 
											<h1 style="text-align: center; text-decoration: underline;">dfsqfdsqfsqfsdf </h1><br/> 
										...
										elseif(isset($_SESSION['email_user']) && $actif_img == 0)
										{
											echo('<center>
										...
										else 
										{
												echo('<form name="frm" id="form_doc" method="post" action="../transfert_achat.php">
													<center>
														...
														<input type="hidden" value="imagePage/5c6c03d90f6b3.php" name="lien_php"/>
