<?php
							...
							$prix_img = 20;
							$lien_php = "imagePage/5cb8748886ed7.php";
								...
								<body> 
									...
									<div id="body"> 
										...
										<center>
											...
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec gravida odio varius finibus rutrum. Donec a felis ut velit elementum vulputate non vel est. Aenean scelerisque pellentesque venenatis. Donec pharetra libero vehicula tempus euismod. Etiam interdum, mi sed ullamcorper euismod, odio velit imperdiet arcu, ac hendrerit purus tellus non felis. Vestibulum aliquet consequat eros, eget placerat sapien aliquet id. Nam convallis vestibulum dui, ac molestie tellus tincidunt eget. Praesent arcu enim, tempus ac bibendum sit amet, feugiat quis lorem. Nullam a justo at magna porta rhoncus.

Fusce pellentesque turpis tincidunt mauris scelerisque consequat. Proin scelerisque ante et justo accumsan imperdiet. Nam nisl velit, ornare in felis sit amet, cursus ultrices ipsum. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper fringilla velit ac pharetra. Duis id arcu consectetur, venenatis felis at, scelerisque metus. Vivamus molestie orci sit amet consequat eleifend. Donec arcu tellus, hendrerit sit amet tortor sed, suscipit varius dolor. Aenean porta tincidunt tempus. Nunc consectetur tellus nec suscipit laoreet. Praesent iaculis diam vel tortor malesuada, at interdum tellus tristique. Cras pharetra, orci id feugiat volutpat, nibh urna varius tortor, vitae iaculis mi turpis nec turpis. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Fusce porttitor aliquet elit at convallis. Proin tellus libero, euismod ut eleifend ac, malesuada sit amet mi.</p> 
										...
										$select_acheteur_dl = "SELECT nom_img, prix_img, lien_img, lien_php, description_img, actif_img, idAcheteur, idUser, idAdmin
												FROM image
									 			WHERE lien_php = 'imagePage/5cb8748886ed7.php';";
										...
										{
											echo('<center>
											<a href="../transfert_delete_img.php?file_delete=imagePage/5cb8748886ed7.php&amp;confirmation=false">
										...
										else 
										{
												echo('<form name="frm" id="form_doc" method="post" action="../transfert_achat.php">
													<center>
														...
														<input type="hidden" value="imagePage/5cb8748886ed7.php" name="lien_php"/>
