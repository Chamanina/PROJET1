<?php
							...
							$prix_img = 10;
							$lien_php = "imagePage/5c6c0ab62cad5.php";
							$lien_img = "image/plage.jpg";
							$idUser = 1;
							$actif_img = 1;
							?> 
							<!DOCTYPE html> <html lang="fr"> 
								...
								<body> 
									...
									<div id="body"> 
										<div id="content"></div> 
											<h1 style="text-align: center; text-decoration: underline;">fsdfsf </h1><br/> 
										...
										if(empty($_SESSION['email_user']))
										{
											...
											$query = "SELECT nom_img, prix_img, lien_img, lien_php, description_img, actif_img, idAcheteur
									 				WHERE lien_php = "imagePage/5c6c0ab62cad5.php""
										...
										else 
										{
												echo('<form name="frm" id="form_doc" method="post" action="../transfert_achat.php">
													<center>
														...
														<input type="hidden" value="image/plage.jpg" name="lien_img"/>
														<input type="hidden" value="1" name="actif_img"/>
														<input type="hidden" value="10" name="prix_img"/>
														<input type="hidden" value="imagePage/5c6c0ab62cad5.php" name="lien_php"/>
