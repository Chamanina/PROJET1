<?php
							...
							$prix_img = 10;
							$lien_php = "imagePage/5c6c178889e85.php";
							$lien_img = "image/peinture.jpg";
							$idUser = 1;
							$actif_img = 1;
							?> 
							<!DOCTYPE html> <html lang="fr"> 
								...
								<body> 
									...
									<div id="body"> 
										<div id="content"></div> 
											<h1 style="text-align: center; text-decoration: underline;">art </h1><br/> 
											<img src="../image/peinture.jpg"style="width:775px ; border-radius: 5px" /><br/><br/>
										...
										$select_acheteur_dl = "SELECT nom_img, prix_img, lien_img, lien_php, description_img, actif_img, idAcheteur
												FROM image
									 			WHERE lien_php = 'imagePage/5c6c178889e85.php';";
										...
										elseif(isset($_SESSION['idUser']) == $exec_dl )
										{
											echo('<center>
										...
										else 
										{
												echo('<form name="frm" id="form_doc" method="post" action="../transfert_achat.php">
													<center>
														...
														<input type="hidden" value="image/peinture.jpg" name="lien_img"/>
														<input type="hidden" value="1" name="actif_img"/>
														<input type="hidden" value="10" name="prix_img"/>
														<input type="hidden" value="imagePage/5c6c178889e85.php" name="lien_php"/>
