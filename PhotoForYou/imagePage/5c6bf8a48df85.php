<?php
							...
							$prix_img = 20;
							$lien_php = "imagePage/5c6bf8a48df85.php";
							...
							<!DOCTYPE html> <html lang="fr"> 
								...
								<body> 
									...
									<div id="body"> 
										<div id="content"></div> 
											<h1 style="text-align: center; text-decoration: underline;">gfdgfdg </h1><br/> 
										...
										else 
										{
												echo('<form name="frm" id="form_doc" method="post" action="../transfert_achat.php">
													<center>
														...
														<input type="hidden" value="imagePage/5c6bf8a48df85.php" name="lien_php"/>
