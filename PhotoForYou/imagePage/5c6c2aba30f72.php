<?php
							...
							$prix_img = 20;
							$lien_php = "imagePage/5c6c2aba30f72.php";
							$lien_img = "image/gateau.jpg";
							$idUser = 1;
							$actif_img = 1;
							?> 
							<!DOCTYPE html> <html lang="fr"> 
								...
								<body> 
									...
									<div id="body"> 
										<div id="content"></div> 
										<center>
											<h1 style="text-align: center; text-decoration: underline;">Gateau </h1><br/> 
...
Et quoniam mirari posse quosdam peregrinos existimo haec lecturos forsitan, si contigerit, quamobrem cum oratio ad ea monstranda deflexerit quae Romae gererentur, nihil praeter seditiones narratur et tabernas et vilitates harum similis alias, summatim causas perstringam nusquam a veritate sponte propria digressurus.</p> 
										...
										$select_acheteur_dl = "SELECT nom_img, prix_img, lien_img, lien_php, description_img, actif_img, idAcheteur, idUser
												FROM image
									 			WHERE lien_php = 'imagePage/5c6c2aba30f72.php';";
										...
										elseif($_SESSION['idUser'] == $result['idAcheteur'])
										{
											echo('
												<center>
													<input type="submit" value="TELECHARGER" name="acheteur_submit" id="submit_button" class="formbutton" onclick=""/>
													<br/><br/>
												</center>
												');
										} 
										...
										else 
										{
												echo('<form name="frm" id="form_doc" method="post" action="../transfert_achat.php">
													<center>
														...
														<input type="hidden" value="image/gateau.jpg" name="lien_img"/>
														<input type="hidden" value="1" name="actif_img"/>
														<input type="hidden" value="20" name="prix_img"/>
														<input type="hidden" value="imagePage/5c6c2aba30f72.php" name="lien_php"/>
